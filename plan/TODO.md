...
- Migrated `ElseOnLoopTransformer`, `BreakContinueTransformer`, and `ConfiguredAliasShadowingTransformer` from `frontend/Program.cs` into `backend/Resolver/Resolver.Resolve` as post-resolution transforms.
