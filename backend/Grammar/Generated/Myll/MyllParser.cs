...
public partial class MyllParser : Parser {
	...
	public ProgContext prog() {
		...
		try {
			...
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			while (_la==LBRACK || (((_la - 103)) & ~0x3f) == 0 && ((1L << (_la - 103)) & 9007199507447713L) != 0) {
				{
				{
				State = 261;
				decl();
		...
		try {
			...
			case LBRACK:
				...
				case LCURLY:
					...
					ErrorHandler.Sync(this);
					_la = TokenStream.LA(1);
					while (((_la) & ~0x3f) == 0 && ((1L << _la) & 4292608L) != 0 || (((_la - 75)) & ~0x3f) == 0 && ((1L << (_la - 75)) & 4430527201279L) != 0 || _la==ID) {
						{
						{
						State = 379;
						attrConvert();
		...
		try {
			...
			case 2:
				...
				case 2:
					...
					ErrorHandler.Sync(this);
					_la = TokenStream.LA(1);
					while (((_la) & ~0x3f) == 0 && ((1L << _la) & 4714966936608780L) != 0 || (((_la - 108)) & ~0x3f) == 0 && ((1L << (_la - 108)) & 2305578801480335885L) != 0) {
						{
						{
						State = 395;
						attrCtor();
		...
		try {
			...
			case LBRACK:
				...
				case LCURLY:
					...
					ErrorHandler.Sync(this);
					_la = TokenStream.LA(1);
					while (_la==STRING_LIT || _la==LBRACK || (((_la - 156)) & ~0x3f) == 0 && ((1L << (_la - 156)) & 15L) != 0) {
						{
						{
						State = 411;
						attrOp();
		...
		try {
			...
			case LBRACK:
				...
				case LCURLY:
					...
					ErrorHandler.Sync(this);
					_la = TokenStream.LA(1);
					while (_la==LBRACK || (((_la - 75)) & ~0x3f) == 0 && ((1L << (_la - 75)) & 4430527201279L) != 0 || _la==ID) {
						{
						{
						State = 443;
						attrVar();
	...
	public StmtContext stmt() {
		...
		try {
			...
			case LCURLY:
				...
				ErrorHandler.Sync(this);
				_la = TokenStream.LA(1);
				while (((_la) & ~0x3f) == 0 && ((1L << _la) & 4714829497524236L) != 0 || (((_la - 108)) & ~0x3f) == 0 && ((1L << (_la - 108)) & 2301356676829676045L) != 0) {
					{
					{
					State = 757;
					stmt();
	...
	public StmtForContext stmtFor() {
		...
		try {
			...
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if (((_la) & ~0x3f) == 0 && ((1L << _la) & 4714760757075980L) != 0 || (((_la - 117)) & ~0x3f) == 0 && ((1L << (_la - 117)) & 4494835746603009L) != 0) {
				{
				State = 823;
				_localctx.cond = expr(0);
				}
	...
	public KindOfVarContext kindOfVar() {
		...
		try {
			...
			_localctx.v = TokenStream.LT(1);
			_la = TokenStream.LA(1);
			if ( !((((_la - 108)) & ~0x3f) == 0 && ((1L << (_la - 108)) & 6815745L) != 0) ) {
				_localctx.v = ErrorHandler.RecoverInline(this);
			}
			else {
				ErrorHandler.ReportMatch(this);
	...
	public PreOPContext preOP() {
		...
		try {
			...
			_localctx.v = TokenStream.LT(1);
			_la = TokenStream.LA(1);
			if ( !(((_la) & ~0x3f) == 0 && ((1L << _la) & 211160993390592L) != 0) ) {
				_localctx.v = ErrorHandler.RecoverInline(this);
			}
			else {
				ErrorHandler.ReportMatch(this);
	...
	public MultOPContext multOP() {
		...
		try {
			...
			_localctx.v = TokenStream.LT(1);
			_la = TokenStream.LA(1);
			if ( !(((_la) & ~0x3f) == 0 && ((1L << _la) & 30802431705088L) != 0) ) {
				_localctx.v = ErrorHandler.RecoverInline(this);
			}
			else {
				ErrorHandler.ReportMatch(this);
	...
	public AddOPContext addOP() {
		...
		try {
			...
			_localctx.v = TokenStream.LT(1);
			_la = TokenStream.LA(1);
			if ( !(((_la) & ~0x3f) == 0 && ((1L << _la) & 2814801306714112L) != 0) ) {
				_localctx.v = ErrorHandler.RecoverInline(this);
			}
			else {
				ErrorHandler.ReportMatch(this);
	...
	public MemAccOPContext memAccOP() {
		...
		try {
			...
			_localctx.v = TokenStream.LT(1);
			_la = TokenStream.LA(1);
			if ( !(((_la) & ~0x3f) == 0 && ((1L << _la) & 36283883749376L) != 0) ) {
				_localctx.v = ErrorHandler.RecoverInline(this);
			}
			else {
				ErrorHandler.ReportMatch(this);
	...
	public MemAccPtrOPContext memAccPtrOP() {
		...
		try {
			...
			_localctx.v = TokenStream.LT(1);
			_la = TokenStream.LA(1);
			if ( !(((_la) & ~0x3f) == 0 && ((1L << _la) & 549755813936L) != 0) ) {
				_localctx.v = ErrorHandler.RecoverInline(this);
			}
			else {
				ErrorHandler.ReportMatch(this);
	...
	public LitContext lit() {
		...
		try {
			...
			State = 986;
			_la = TokenStream.LA(1);
			if ( !(_la==STRING_LIT || _la==CHAR_LIT || (((_la - 161)) & ~0x3f) == 0 && ((1L << (_la - 161)) & 255L) != 0) ) {
			ErrorHandler.RecoverInline(this);
			}
			else {
				ErrorHandler.ReportMatch(this);
	...
	public FloatingTypeContext floatingType() {
		...
		try {
			...
			_localctx.v = TokenStream.LT(1);
			_la = TokenStream.LA(1);
			if ( !((((_la - 86)) & ~0x3f) == 0 && ((1L << (_la - 86)) & 122881L) != 0) ) {
				_localctx.v = ErrorHandler.RecoverInline(this);
			}
			else {
				ErrorHandler.ReportMatch(this);
	...
	public BinaryTypeContext binaryType() {
		...
		try {
			...
			_localctx.v = TokenStream.LT(1);
			_la = TokenStream.LA(1);
			if ( !((((_la - 82)) & ~0x3f) == 0 && ((1L << (_la - 82)) & 122881L) != 0) ) {
				_localctx.v = ErrorHandler.RecoverInline(this);
			}
			else {
				ErrorHandler.ReportMatch(this);
	...
	public SignedIntTypeContext signedIntType() {
		...
		try {
			...
			_localctx.v = TokenStream.LT(1);
			_la = TokenStream.LA(1);
			if ( !((((_la - 78)) & ~0x3f) == 0 && ((1L << (_la - 78)) & 7685L) != 0) ) {
				_localctx.v = ErrorHandler.RecoverInline(this);
			}
			else {
				ErrorHandler.ReportMatch(this);
	...
	public UnsignIntTypeContext unsignIntType() {
		...
		try {
			...
			_localctx.v = TokenStream.LT(1);
			_la = TokenStream.LA(1);
			if ( !((((_la - 79)) & ~0x3f) == 0 && ((1L << (_la - 79)) & 61445L) != 0) ) {
				_localctx.v = ErrorHandler.RecoverInline(this);
			}
			else {
				ErrorHandler.ReportMatch(this);
	...
	public TypePtrContext typePtr() {
		...
		try {
			...
			case STAR:
				...
				_la = TokenStream.LA(1);
				if ( !(((_la) & ~0x3f) == 0 && ((1L << _la) & 3221226560L) != 0) ) {
			...
			case 1:
				...
				_la = TokenStream.LA(1);
				if ( !(((_la) & ~0x3f) == 0 && ((1L << _la) & 1196285830889472L) != 0) ) {
	...
	public FuncTypeDefContext funcTypeDef() {
		...
		try {
			...
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if ((((_la - 75)) & ~0x3f) == 0 && ((1L << (_la - 75)) & 4430527201279L) != 0 || _la==ID) {
				{
				State = 1132;
				param();
				State = 1137;
		...
		try {
			...
			if (_la==LCURLY) {
				...
				do {
					...
					ErrorHandler.Sync(this);
					_la = TokenStream.LA(1);
				} while ( _la==LBRACK || (((_la - 106)) & ~0x3f) == 0 && ((1L << (_la - 106)) & 1835023L) != 0 );
				State = 1347;
				Match(RCURLY);
				}
			}
